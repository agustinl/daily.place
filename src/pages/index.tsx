	...
	return (
		<>
			...
			>
				...
				<Text component="p">
					Everything is <b>saved and available</b> in your browser under a name of your choosing.
				</Text>
				<Text
					component="p"
					m={0}
				>
					The information is stored in the local storage of your browser. It will be available as long as it
					is not deleted or you do not use the app in incognito mode.
				</Text>
				<Text
					component="p"
					fz={14}
				...
				<Grid gutter="xl">
					...
					>
						<Text
							...
							m={0}
						>
							<span className={classes.spanBold}>Playlist.</span>9 differents sounds. Mix them and control
							their volume.
						</Text>
					</Grid.Col>
